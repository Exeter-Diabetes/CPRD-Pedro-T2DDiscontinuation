...
# Predict percentage for 12m
## SGLT2
if (class(try(
  
  predictions_SGLT2_12m <- readRDS("results/Models/bartmachine/predictions_SGLT2_12m.rds")
  
  , silent = TRUE)) == "try-error") {
  
  predictions_SGLT2_12m <- predict(bartmachine_full_model_12m,
                                  cprd_dataset.12m %>%
                                    select(drugclass, 
                                           dstartdate_age, 
                                           gender, 
  ...
  saveRDS(predictions_SGLT2_12m, "results/Models/bartmachine/predictions_SGLT2_12m.rds")
...
if (class(try(
  ...
  predictions_GLP1_12m <- readRDS("results/Models/bartmachine/predictions_GLP1_12m.rds")
  
  , silent = TRUE)) == "try-error") {
  
  predictions_GLP1_12m <- predict(bartmachine_full_model_12m,
                                  cprd_dataset.12m %>%
                                    select(drugclass, 
                                           dstartdate_age, 
                                           gender, 
  ...
  saveRDS(predictions_GLP1_12m, "results/Models/bartmachine/predictions_GLP1_12m.rds")
...
if (class(try(
  ...
  predictions_DPP4_12m <- readRDS("results/Models/bartmachine/predictions_DPP4_12m.rds")
  
  , silent = TRUE)) == "try-error") {
  
  predictions_DPP4_12m <- predict(bartmachine_full_model_12m,
                                 cprd_dataset.12m %>%
                                   select(drugclass, 
                                          dstartdate_age, 
                                          gender, 
  ...
  saveRDS(predictions_DPP4_12m, "results/Models/bartmachine/predictions_DPP4_12m.rds")
...
if (class(try(
  ...
  predictions_TZD_12m <- readRDS("results/Models/bartmachine/predictions_TZD_12m.rds")
  
  , silent = TRUE)) == "try-error") {
  
  predictions_TZD_12m <- predict(bartmachine_full_model_12m,
                                 cprd_dataset.12m %>%
                                   select(drugclass, 
                                          dstartdate_age, 
                                          gender, 
  ...
  saveRDS(predictions_TZD_12m, "results/Models/bartmachine/predictions_TZD_12m.rds")
...
if (class(try(
  ...
  predictions_SU_12m <- readRDS("results/Models/bartmachine/predictions_SU_12m.rds")
  
  , silent = TRUE)) == "try-error") {
  
  predictions_SU_12m <- predict(bartmachine_full_model_12m,
                                cprd_dataset.12m %>%
                                  select(drugclass, 
                                         dstartdate_age, 
                                         gender, 
  ...
  saveRDS(predictions_SU_12m, "results/Models/bartmachine/predictions_SU_12m.rds")
...
interim_dataset <- cprd_dataset.12m %>%
  as.data.frame() %>%
  mutate(
    pred.SGLT2 = predictions_SGLT2_12m,
    pred.GLP1 = predictions_GLP1_12m,
    pred.DPP4 = predictions_DPP4_12m,
    pred.SU = predictions_SU_12m,
...
pdf("results/figures/07.drug_vs_drug_calibration_12m.pdf", width = 17, height = 7)
...
pdf("results/figures/07.absolute_relative_development_12m.pdf", width = 20, height = 7)
